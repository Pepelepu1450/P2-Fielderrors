...
var labelUser = document.getElementById("label_user");
...
var validateAndSend = function (e) {
    ...
    if (username === "" || password === "") {
        if (username === ""){
            if (inputUsername.className.indexOf("danger-color") === -1){
                inputUsername.className += "danger-color";
                labelUser.className += "rad-label";
            }
            inputUsername.focus();
        }        
        else{
        ...
        if(password === ""){
            if(inputPassword.className.indexOf("danger-color") === -1){
                inputPassword.className += "danger-color";
                labelPassword.className += "red-label";
            }
        }
